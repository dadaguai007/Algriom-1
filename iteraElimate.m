...
phi=pi/4;
VbQ_sin = Vdither*Creat_dither_phi1(fs,f2,N*(f2/f1),phi);
VbI_sin = Vdither*Creat_dither_phi1(fs,f1,N,phi);
VbI_cos = Vdither*Creat_dither_phi(fs,f1,N,phi);
VbQ_cos = Vdither*Creat_dither_phi(fs,f2,N*(f2/f1),phi);
